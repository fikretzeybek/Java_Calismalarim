...
public class Islemler {
    ...
    public void kitapEkleme() {
        ...
        kitapci_project.Kitap kitap = new kitapci_project.Kitap(kitapNo++, kitapAdi, yazarAdi, kitapFiyati, LocalDateTime.now()); //kitap sınıfından parametreli cons. kullanarak bir obje oluşturuldu
